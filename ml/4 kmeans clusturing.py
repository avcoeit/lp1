...
# Is there any relationship between annual income and spending score?
plt.figure(figsize=(20,8))
sns.barplot(x='Annual Income (k$)',y='Spending Score (1-100)',data=mall_data)


# For our model, we can choose those variables which are relevant or necessary, we needn't choose all.
...
wcss = []
for i in range(1,11):#It will find wcss value for different number of clusters (for 1 cluster, for 2...until 10 clusters) and put it in list
